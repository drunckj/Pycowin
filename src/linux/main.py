...
"color: rgb(238, 0, 157);")
    ...
    #for linux
        ...
        #if is_windows==0:
        directory_path = str(os.getcwd())+"/injection.ico"
        os.system("notify-send --icon="+directory_path+ " Vaccines found" )
        os.system("spd-say 'Vaccines found.Vaccines found.Vaccines found.'")
        time.sleep(1.5)
